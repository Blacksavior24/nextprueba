...
import { useGetCardsEmitidos } from "@/lib/queries/cards.queries";
...
export default function Page() {
  ...
  const {data: cards, isLoading, refetch, error } = useGetCardsEmitidos()
          ...
          {isLoading ? (
              ...
              currentCards.map((card) => (
                <TableRow key={card.id}>
                  ...
                  <TableCell>{card.fechaIngreso?'Fuera de plazo':'En plazo'}</TableCell>
